...
fn body(g: Glyph) -> &'static str {
    ...
    match g {
        ...
        Debug => "<path d='M6.9 11.3 C6.9 8.4 9.1 6.6 12 6.6 C14.9 6.6 17.1 8.4 17.1 11.3 V14.5 C17.1 17.4 14.9 19 12 19 C9.1 19 6.9 17.4 6.9 14.5 Z'/>\
             <path d='M12 6.9 V18.7'/>\
             <path d='M9.5 6.8 L7.9 4.9'/><path d='M14.5 6.8 L16.1 4.9'/>\
             <path d='M6.9 11.2 L2.9 9.9'/><path d='M6.9 14.9 L2.9 16.3'/><path d='M17.1 11.2 L21.1 9.9'/><path d='M17.1 14.9 L21.1 16.3'/>",
        CallGraph => "<path d='M12 8.65 L7.3 15.25'/><path d='M12 8.65 L16.7 15.25'/>\
