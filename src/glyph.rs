...
fn body(g: Glyph) -> &'static str {
    ...
    match g {
        ...
        Debug => "<path d='M7.2 11.4 C7.2 8.6 9.3 6.9 12 6.9 C14.7 6.9 16.8 8.6 16.8 11.4 V14.4 C16.8 17.2 14.7 18.9 12 18.9 C9.3 18.9 7.2 17.2 7.2 14.4 Z'/>\
             <path d='M12 7.2 V18.6'/>\
             <path d='M9.6 7.1 L8 5.1'/><path d='M14.4 7.1 L16 5.1'/>\
             <path d='M7.2 11.3 L3.2 10'/><path d='M7.2 14.9 L3.2 16.3'/><path d='M16.8 11.3 L20.8 10'/><path d='M16.8 14.9 L20.8 16.3'/>",
