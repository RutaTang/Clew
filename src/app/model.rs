...
pub(crate) fn encode_col(line: &str, byte: usize, utf16: bool) -> usize {
...
pub(crate) const EXPLAIN_SYSTEM: &str = "You are an expert code explainer. You are given a \
...
pub(crate) const EXPLAIN_BLOCKS_SYSTEM: &str = "You are an expert code explainer. Walk \
...
pub(crate) const ASK_SYSTEM: &str = "You are answering a developer's questions about THIS \
...
pub(crate) const WHY_SYSTEM: &str = "You explain WHY a specific piece of code exists, using \
...
pub(crate) const TIME_WHY_SYSTEM: &str = "You explain a single git commit's change to a \
...
pub(crate) const TIME_STORY_SYSTEM: &str = "You are telling the story of how ONE code block \
...
/// signature ending in `;`).
pub(crate) fn fn_body_end(lines: &[&str], start: usize) -> Option<usize> {
    let mut paren = 0i32;
    let mut brace = 0i32;
